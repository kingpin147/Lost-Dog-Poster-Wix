...
export const generatePoster = webMethod(Permissions.Anyone, async (formData) => {
  try {
    ...
    // ========== 1) LARGE RED HEADER ===========
    // Increased header height to 100px for more space.
    const headerHeight = 100;
    doc.setFillColor(220, 20, 60);
    doc.rect(0, 0, docWidth, headerHeight, "F");

    // Increase the “FOUND!” font size and center it vertically in the header:
    doc.setFont("helvetica", "bold");
    doc.setFontSize(60);
    doc.setTextColor(255, 255, 255);
    doc.text("FOUND!", docWidth / 2, headerHeight / 2 + 15, { align: "center" });

    // ========== 2) PET NAME ===========
    // Adjusted y-position to follow the larger header
    doc.setFontSize(28);
    ...
    // ========== 5) FOUND WHERE ==========
    // Use a red bar to label the "FOUND WHERE" section.
    doc.setFillColor(220, 20, 60);
    ...
    // ========== 6) FOOTER ==========
    // Increase footer height to 100px for more clarity.
    ...
    // "CALL WITH ANY INFORMATION" line positioned within the footer.
    doc.setFontSize(16);
